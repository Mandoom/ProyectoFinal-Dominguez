...
function NavBar ({pageTitle, bg, pad, color, brandfont }) { 
 return(
    <div className='navbar'style={{backgroundColor : bg, padding: pad, color : color}}>
        <div className='brand'>
        <div className="logo">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980 978.94" width="80" height="80" fill="currentColor">
        ...
        <nav>
           <ul className='menu'>
                <li className='menu-link'>Nav 1</li>
                <li className='menu-link'>Nav 2</li>
                <li className='menu-link'>Nav 3</li>
           </ul>
        </nav>
